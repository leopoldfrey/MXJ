{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 25.0, 80.0, 710.0, 423.0 ],
		"bglocked" : 0,
		"defrect" : [ 25.0, 80.0, 710.0, 423.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.0, 377.0, 206.0, 18.0 ],
					"text" : "recallmulti 5.47 7.63 3.35"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 338.5, 277.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 283.5, 277.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 228.0, 277.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.0, 303.0, 130.0, 20.0 ],
					"text" : "pak 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.0, 330.0, 215.0, 18.0 ],
					"text" : "recallmultisym pst5 $1 7 $2 pst3 $3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.0, 54.0, 91.0, 18.0 ],
					"text" : "swap pst4 pst6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 486.0, 52.0, 59.0, 18.0 ],
					"text" : "swap 3 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 11.0, 71.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 78.0, 53.0, 130.0, 18.0 ],
					"text" : "recallsym pst5 pst2 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 22.0, 267.0, 128.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 415.0, 144.0, 23.0, 20.0 ],
					"text" : "all"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 419.0, 162.0, 13.0, 20.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-25",
					"items" : [ "(PattrWrapper.json)", ",", 1, "-", "pst1", ",", 2, "-", "pst2", ",", 3, "-", "pst3", ",", 4, "-", "pst4", ",", 5, "-", "pst5", ",", 6, "-", "pst6", ",", 7, "-", "pst7" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 448.0, 165.0, 137.0, 20.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 494.0, 210.0, 114.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 14.0, 157.0, 29.0 ],
					"text" : "[mxj lf.pattrwrap]",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 323.0, 161.0, 91.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 305.0, 137.0, 54.0, 20.0 ],
					"prefix_mode" : 1,
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 448.0, 135.0, 64.0, 18.0 ],
					"text" : "setitem $1"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"hidden" : 0,
					"midpoints" : [ 425.5, 186.0, 400.5, 186.0 ],
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 516.5, 186.0, 485.5, 186.0 ],
					"source" : [ "obj-25", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 400.5, 270.0, 408.0, 270.0, 408.0, 186.0, 428.833344, 186.0 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 443.0, 244.0, 591.0, 244.0, 591.0, 161.0, 457.5, 161.0 ],
					"source" : [ "obj-34", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"hidden" : 0,
					"midpoints" : [ 332.5, 186.0, 400.5, 186.0 ],
					"source" : [ "obj-35", 0 ]
				}
