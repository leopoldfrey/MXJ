...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 191.0, 91.0, 20.0 ],
					"text" : "prepend preset"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 103.0, 320.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 346.0, 112.0, 18.0 ],
					"text" : "display_number $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 335.0, 367.0, 206.0, 18.0 ],
					"text" : "recallmulti 5.228 7.116 3.38"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 320.5, 267.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 265.5, 267.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 210.0, 267.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 293.0, 130.0, 20.0 ],
					"text" : "pak 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 320.0, 215.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 19.0, 55.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 57.0, 130.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 338.0, 60.0, 91.0, 18.0 ],
					"text" : "swap pst4 pst6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 439.0, 58.0, 59.0, 18.0 ],
					"text" : "swap 3 7"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-25",
					"items" : [ "(PattrWrapper.json)", ",", "pst1", ",", "pst2", ",", "pst3", ",", "pst4", ",", "pst5", ",", "pst6", ",", "pst7" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 14.0, 167.0, 29.0 ],
					"text" : "[mxj lf.pattrwrap2]",
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 516.5, 187.5, 485.5, 187.5 ],
					"source" : [ "obj-25", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 400.5, 270.0, 408.0, 270.0, 408.0, 186.0, 443.0, 186.0 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "PattrWrapper.json",
				"bootpath" : "/Users/leo/Documents/__PATCHS/__MXJ/release/lf.pattrwrap_java_v0.4",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
