...
// SPLITS ONLY FIRST ATOM

public class Splitter3 extends LfObject
{
	private String exp = ".";
	
	public Splitter3(Atom[] atoms)
	{
		version = 0.1f;
		build = "31/01/2013";
	...
	{
		String str = atoms[0].toString();//Atom.toOneString(atoms);
		...
		//post("Result : "+fistr);
		Atom[] rest = Atom.removeFirst(atoms);
		outlet(0, Atom.parse(fistr+Atom.toOneString(rest)));
